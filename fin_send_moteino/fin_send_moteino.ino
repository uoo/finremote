...
#define NETWORKID     12  // the same on all nodes that talk to each other (range up to 255)
#define GATEWAYID     1   // this is the one we're sending to
//Match frequency to the hardware version of the radio on your Moteino (uncomment one):
//#define FREQUENCY   RF69_433MHZ
//#define FREQUENCY   RF69_868MHZ
#define FREQUENCY     RF69_915MHZ
#define ENCRYPTKEY    "yourencryptkey12" //exactly the same 16 characters/bytes on all nodes!
